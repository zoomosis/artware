...
{  uchar programName[46];
   u16   memRequired;      } FM12archiverInfo;
...
typedef struct
{
   ...
   word              : 1; /* BIT 12 */
   word              : 2;
   word _RA2         : 1; /* BIT 15 */  } FM12genOptionsType;
...
typedef struct
{
   ...
   word killEmptyNetmail : 1; /* Bit 15 */  } FM12mailOptionsType;
...
typedef struct
{
   ...
   word              : 1; /* bit 13   */
   word              : 1; /* bit 14   */
   word sysopImport  : 1; /* bit 15   */ } FM12mbOptionsType;
...
typedef struct
{
   ...
   word allowCompr   : 1; /* Bit 15 */  } FM12mgrOptionsType;
...
typedef struct
{
   ...
   word             : 3; /* Bit 11-13 */
   word arrivalDate : 1; /* Bit 14 */
   word sysopRead   : 1; /* Bit 15 */     } defaultOptionsType;
#endif
...
typedef struct
{
   ...
   uchar       reserved[9];  } FM12uplinkReqType;

typedef struct
{  u16   valid;
   u16   zone;
   u16   net;
   u16   node;    } FM12akaMatchNodeType;

typedef struct
{
   FM12akaMatchNodeType amNode;
   u16              aka;    } FM12akaMatchType;
...
typedef struct
{
   ...
   u32             alsoSeenBy;
   areaStatType    stat;
   uchar           reserved[180];   } FM12rawEchoType;
