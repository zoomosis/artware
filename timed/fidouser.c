    ...
    while (low <= high)
    {
        ...
        else
        {
            ...
            {                   /* Match, match! */
                ...
                while (--mid >= 0)
                {
                    lseek(f, (long)((long)mid * (long)reclength),
                          SEEK_SET);
                    read(f, midname, reclength);
                    midname[reclength] = '\0';
                    strlwr(midname);
                ...
                /* We are now positioned just before the first match, or
                   at offset -1 */

                lseek(f, (long)((long)++mid * (long)reclength), SEEK_SET); /* goto 
                                                                              first 
                                                                              match 
                                                                            */
