...
void edit_hello_strings(AREA * area)
{
    ...
    editbox =
        initbox(3, 0, 22, 79, cfg.col[Cfindactive], cfg.col[Cfindtext],
                DOUBLE, YES, ' ');
    drawbox(editbox);
    ...
    while (action < 5)
    {
        ...
        case 0:
            ...
            while ((ret != ESC) && (ret != 0))
            {
                ...
                ret =
                    getstring(8, 3, custom.rephello, 76, 300, "",
        ...
        case 1:
                   ...
                   && (ret != BTAB))
            {
                ...
                ret =
                    getstring(11, 3, custom.hello, 76, 300, "",
                              cfg.col[Centry], cfg.col[Cfinddata]);
                if ((strlen(custom.hello) < 301)
        ...
        case 2:
                   ...
                   && (ret != BTAB))
            {
                ...
                ret =
                    getstring(14, 3, custom.followhello, 76, 300, "",
                              cfg.col[Centry], cfg.col[Cfinddata]);
                if ((strlen(custom.followhello) < 301)
        ...
        case 3:
                   ...
                   && (ret != BTAB))
            {
                ...
                ret =
                    getstring(17, 3, custom.signoff, 76, 300, "",
                              cfg.col[Centry], cfg.col[Cfinddata]);
                if ((strlen(custom.signoff) < 301)
        ...
        case 4:
                   ...
                   && (ret != BTAB))
            {
                ...
                ret =
                    getstring(20, 3, custom.origin, 76, 76, "",
                              cfg.col[Centry], cfg.col[Cfinddata]);
                if ((strlen(custom.origin) < 76)
    ...
    if ((changed == 0) || (confirm("Data changed. Save? [y/N]") == 0))
        return;
