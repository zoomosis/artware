...
void WalkChain(MARKLIST *marklist, MARKLIST *history, MSG *areahandle, dword curno);
...
void MarkReplyChain(AREA *area, MSG *areahandle, dword startmsg)
{
   ...
   sprintf(msg, " þ %d messages were marked. Press any key.", history->active);
   statusbar(msg);
...
void WalkChain(MARKLIST *marklist, MARKLIST *history, MSG *areahandle, dword curno)
{
   ...
   // Prevent lockups dus to lack of stackspace, because this is a recursive
   // function!
