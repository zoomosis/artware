...
#define MSGTYPE_JAM     0x04     /* GvE */
#define MSGTYPE_HMB     0x10     /* GvE */
#define MSGTYPE_LOCAL   0x20     /* GvE */
#define MSGTYPE_NET     0x40     /* GvE */
...
typedef struct
{
  ...
  #define ADD_DIR     0x00020000L
  #define ADD_AS      0x00040000L
  #define ADD_IMM     0x00080000L
  #define ADD_KFS     0x00100000L
  #define ADD_TFS     0x00200000L
  #define ADD_CFM     0x00400000L
  #define ADD_LOK     0x00800000L
...
sword EXPENTRY MsgOpenApi(struct _minf *minf, char *path, word useflags, char *hudson);
...
word _CopyToBuf(byte *p, byte *out, byte **end);
byte * EXPENTRY CopyToControlBuf(byte *txt, byte **newtext, unsigned *length);
void EXPENTRY ConvertControlInfo(byte *ctrl,NETADDR *orig,NETADDR *dest, XMSG *hdr);
