...
#include "stamp.h"
  ...
  #ifdef __WATCOMC__
    #if __WCVER__ <= 800
      #define actime acctime
    #endif

    #if defined(__SMALL__) || defined(__TINY__)
      #pragma library ("wc_libs.lib");
    #elif defined (__MEDIUM__)
      #pragma library ("wc_libm.lib");
    #elif defined (__COMPACT__)
      #pragma library ("wc_libc.lib");
    #elif defined (__LARGE__)
      #pragma library ("wc_libl.lib");
    #elif defined (__FLAT__)
      #pragma library ("w3_libf.lib");
    #endif
  #endif
